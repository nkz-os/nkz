...
-- FIXED VERSION: Use postgres user or grant ALTER permissions
-- =============================================================================
-- Adds last_notification_days array to track which notification thresholds have been sent

-- Grant ALTER permission to timescale user (if needed)
-- ALTER TABLE activation_codes OWNER TO timescale;
