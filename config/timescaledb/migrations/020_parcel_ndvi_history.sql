-- =============================================================================
-- Migration 020: NDVI time series storage (opt-in)
-- =============================================================================
-- Creates parcel_ndvi_history hypertable for time-series NDVI samples.
-- Idempotent: uses IF NOT EXISTS and create_hypertable with if_not_exists.
-- =============================================================================

-- Ensure UUID extension (commonly present in this database)
...
CREATE TABLE IF NOT EXISTS parcel_ndvi_history (
    ...
    CONSTRAINT uq_parcel_ndvi_history UNIQUE (job_id, time, parcel_id)
);
...
-- -----------------------------------------------------------------------------
-- Indexes for multitenant queries and ordering by time
-- -----------------------------------------------------------------------------
