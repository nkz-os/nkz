"""Minimal smoke test for isobus-bridge."""
...
_MAIN_FILE = os.path.join(_SVC_DIR, "isobus_bridge.py")
...
def test_import():
    ...
    try:
        importlib.import_module("isobus_bridge")
    except (ModuleNotFoundError, ImportError) as e:
        pytest.fail(f"Could not import isobus_bridge: {e}")
