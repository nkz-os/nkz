"""Minimal smoke test for task-queue."""
...
_MAIN_FILE = os.path.join(_SVC_DIR, "task_queue.py")
...
def test_import():
    ...
    try:
        importlib.import_module("task_queue")
    except (ModuleNotFoundError, ImportError) as e:
        pytest.fail(f"Could not import task_queue: {e}")
