"""Minimal smoke test for email-service."""
...
_MAIN_FILE = os.path.join(_SVC_DIR, "email_service.py")
...
def test_import():
    ...
    try:
        ...
        # If the failure is about missing extras (e.g. Flask, psycopg2),
        # fail explicitly — these are production deps.
        pytest.fail(f"Could not import email_service: {e}")
