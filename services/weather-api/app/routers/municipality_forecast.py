...
Stateless: no DB reads, no DB writes. Data is fetched on-demand and discarded.
"""
...
def get_municipality_forecast(
    ...
    Resolves municipality coordinates from catalog_municipalities,
    fetches forecast from Open-Meteo, and returns it directly.
