"""Minimal smoke test for mqtt-credentials-manager."""
...
_MAIN_FILE = os.path.join(_SVC_DIR, "mqtt_credentials_manager.py")
...
def test_import():
    ...
    try:
        importlib.import_module("mqtt_credentials_manager")
    except (ModuleNotFoundError, ImportError) as e:
        pytest.fail(f"Could not import mqtt_credentials_manager: {e}")
