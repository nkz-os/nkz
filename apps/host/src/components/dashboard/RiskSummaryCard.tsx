...
const SEVERITY_CONFIG: Record<string, SeverityCfg> = {
  critical: { badge: 'bg-nkz-danger-soft text-red-800 dark:bg-red-900/40 dark:text-red-300',         bar: 'bg-nkz-danger',    dot: 'bg-nkz-danger',    key: 'dashboard.risks.severity.critical' },
  ...
  medium:   { badge: 'bg-nkz-warning-soft text-yellow-800 dark:bg-yellow-900/40 dark:text-yellow-300', bar: 'bg-nkz-warning', dot: 'bg-nkz-warning', key: 'dashboard.risks.severity.medium' },
