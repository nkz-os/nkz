    ...
    <div className="space-y-4">
      ...
      {entityType === 'AutonomousMobileRobot' && (
        <div className="p-3 bg-nkz-warning-soft border border-yellow-200 rounded-lg text-sm text-yellow-800">
          <strong>Nota:</strong> Tras crear el robot, ve a <a href="/connectivity" className="underline font-medium">Device Management</a> para activar su acceso a la red SDN con el Claim Code del chasis.
        </div>
      )}
